/** Base64URL 补 padding，使长度 % 4 === 0，避免部分浏览器 atob 失败 */
function jwtPadBase64Url(s) {
...
function jwtDecodeSegment(seg) {
    const b64 = jwtPadBase64Url(seg.replace(/-/g, '+').replace(/_/g, '/'));
    return atob(b64);
}
...
function jwtDecode() {
    ...
    try {
        const h = JSON.parse(jwtDecodeSegment(parts[0])),
            p = JSON.parse(jwtDecodeSegment(parts[1]));
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { jwtPadBase64Url, jwtDecodeSegment };
}
