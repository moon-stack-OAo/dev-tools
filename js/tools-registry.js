...
const tools = [
    ...
    },
    {
        ...
        icon: "bi-rulers",
        name: "CSS 单位换算",
        desc: "px / rem / em / vw / vh / % 互转（可配根字号与视口）",
        cat: "generate",
        tags: ["common","frontend"],
    },
    {
        ...
        icon: "bi-shadows",
        name: "阴影生成器",
        desc: "可视化 box-shadow 多阴影 / inset / 实时预览",
        cat: "generate",
        tags: ["common","frontend"],
    },
    {
    ...
    },
    {
        ...
        icon: "bi-bezier2",
        name: "贝塞尔曲线",
        desc: "拖拽控制点调 cubic-bezier，预览动画曲线",
        cat: "generate",
        tags: ["common","frontend"],
    },
    {
    ...
    },
    {
        ...
        desc: "缓存策略可视化生成 Cache-Control / CDN 相关头",
        cat: "generate",
        tags: ["common","frontend","backend"],
    },
    {
    ...
    },
    {
        ...
        icon: "bi-code-slash",
        name: "JSON → 多语言",
        desc: "JSON 生成 TypeScript / Kotlin / Go / C# / Python / Rust",
        cat: "codegen",
        tags: ["common","frontend"],
    },
    {
    ...
    },
    {
        ...
        name: "DDL → 实体",
        desc: "DDL 生成 JPA Entity / Prisma Schema",
        cat: "codegen",
        tags: ["common","backend","java"],
    },
    {
        id: "openapi2ts",
        icon: "bi-filetype-tsx",
    ...
    },
    {
        ...
        icon: "bi-layers",
        name: "DDL → CRUD",
        desc: "DDL 生成 Entity/Mapper/Service/Controller",
        cat: "codegen",
        tags: ["java","backend"],
    },
    {
