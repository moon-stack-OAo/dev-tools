const IDEA_KEYS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        cmd: "Ctrl + Alt + Left",
        syntax: "Ctrl + Alt + Left",
        desc: "后退",
        examples: ["返回上一个导航位置"],
      },
      {
        cmd: "Ctrl + Alt + Right",
        syntax: "Ctrl + Alt + Right",
        desc: "前进",
        examples: ["前进到下一个导航位置"],
      },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        syntax: "Ctrl + F8",
        desc: "切换断点",
        examples: ["在当前行添加/删除断点"],
      },
      {
        cmd: "Ctrl + Shift + F8",
        syntax: "Ctrl + Shift + F8",
        desc: "查看所有断点",
        examples: ["管理所有断点"],
      },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        syntax: "Ctrl + Alt + T",
        desc: "包围代码",
        examples: ["用 if/try/for 等包围代码"],
      },
      {
        cmd: "Ctrl + J",
        syntax: "Ctrl + J",
        desc: "插入模板",
        examples: ["插入 Live Template"],
      },
      {
        cmd: "iter",
        syntax: "iter + Tab",
      ...
      },
      {
        ...
        syntax: "fori + Tab",
        desc: "for 循环模板",
        examples: ["生成带索引的 for 循环"],
      },
      {
        cmd: "ifn",
        syntax: "ifn + Tab",
        desc: "if null 模板",
        examples: ["生成 if (x == null) 语句"],
      },
      {
        cmd: "inn",
        syntax: "inn + Tab",
    ...
    items: [
      {
        ...
        syntax: "⌘ + Space",
        desc: "代码补全",
        examples: ["对应 Windows Ctrl + Space"],
      },
      {
        cmd: "⌘ + N",
        syntax: "⌘ + N",
        desc: "查找类",
        examples: ["对应 Windows Ctrl + N"],
      },
      {
        cmd: "⌘ + Shift + N",
        syntax: "⌘ + Shift + N",
      ...
      },
      {
        ...
        syntax: "⌘ + B",
        desc: "跳转到声明",
        examples: ["对应 Windows Ctrl + B"],
      },
      {
        cmd: "⌘ + Alt + L",
        syntax: "⌘ + Alt + L",
        desc: "格式化代码",
        examples: ["对应 Windows Ctrl + Alt + L"],
      },
      {
        cmd: "⌘ + /",
        syntax: "⌘ + /",
        desc: "行注释",
        examples: ["对应 Windows Ctrl + /"],
      },
      {
        cmd: "⌘ + D",
        syntax: "⌘ + D",
        desc: "复制当前行",
        examples: ["对应 Windows Ctrl + D"],
      },
      {
        cmd: "⌘ + Y",
        syntax: "⌘ + Y",
        desc: "删除当前行",
        examples: ["对应 Windows Ctrl + Y"],
      },
      {
        cmd: "⌃ + Space",
        syntax: "⌃ + Space",
        desc: "代码补全",
        examples: ["Mac 原生冲突，需修改快捷键"],
      },
      {
        cmd: "⌘ + Shift + T",
        syntax: "⌘ + Shift + T",
      ...
      },
      {
        ...
        syntax: "⌘ + Alt + M",
        desc: "提取方法",
        examples: ["对应 Windows Ctrl + Alt + M"],
      },
      {
        cmd: "⌘ + Alt + V",
        syntax: "⌘ + Alt + V",
        desc: "提取变量",
        examples: ["对应 Windows Ctrl + Alt + V"],
      },
    ],
  },
];
  ...
  IDEA_KEYS.forEach((group) => {
    ...
    matched.forEach((item) => {
      ...
      if (item.examples && item.examples.length) {
        ...
        html += `<div style="font-size:11px;color:var(--text-dim)">${escapeHtml(item.examples[0])}</div>`;
      }
      card.innerHTML = html;
