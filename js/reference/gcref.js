  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "触发并发标记的堆占用率",
        examples: [
          "java -XX:+UseG1GC -XX:InitiatingHeapOccupancyPercent=35 MyApp",
        ],
        returns: "触发阈值",
      },
      {
    ...
    items: [
      {
        ...
        examples: [
          "java -XX:+UseG1GC -XX:MaxGCPauseMillis=50 -XX:G1NewSizePercent=30 web-app.jar",
        ],
        returns: "低延迟 GC 配置",
      },
      {
        ...
        examples: [
          "java -XX:+UseParallelGC -XX:GCTimeRatio=99 -XX:ParallelGCThreads=8 batch.jar",
        ],
        returns: "高吞吐 GC 配置",
      },
      {
        ...
        desc: "堆 > 8GB，要求低延迟",
        examples: [
          "java -XX:+UseZGC -Xmx32g -XX:SoftMaxHeapSize=28g big-heap.jar",
        ],
        returns: "大堆 GC 配置",
      },
      {
        ...
        desc: "堆内存有限，需要精细控制",
        examples: [
          "java -XX:+UseG1GC -XX:G1HeapRegionSize=8m -XX:G1ReservePercent=20 low-mem.jar",
        ],
        returns: "内存优化配置",
      },
    ],
