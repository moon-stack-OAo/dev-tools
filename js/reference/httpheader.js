const HTTP_HEADERS = [
  ...
  },
  {
    name: "Date",
    dir: "通用",
    example: "Tue, 15 Apr 2025 12:00:00 GMT",
    desc: "消息发送时间（RFC 1123 格式）",
  },
  {
    name: "Pragma",
    dir: "通用",
    example: "no-cache",
    desc: "HTTP/1.0 兼容的缓存控制（HTTP/1.1 用 Cache-Control）",
  },
  {
    name: "Trailer",
    dir: "通用",
    example: "Expires",
    desc: "chunked 编码尾部 header 字段名列表",
  },
  {
  ...
  },
  {
    ...
    dir: "通用",
    example: "websocket",
    desc: "协议升级（HTTP Upgrade 到 WebSocket 等）",
  },
  {
    name: "Via",
    dir: "通用",
    example: "1.1 proxy.example.com",
    desc: "代理服务器信息（每经过一层代理追加）",
  },
  {
    name: "Warning",
    dir: "通用",
  ...
  },
  {
    ...
    dir: "请求",
    example: '"67ab43"',
    desc: "条件请求：ETag 匹配才执行（乐观锁 / 防止并发修改）",
  },
  {
  ...
  },
  {
    ...
    dir: "请求",
    example: '"67ab43"',
    desc: "条件请求：ETag 不匹配才返回（304 缓存协商）",
  },
  {
    name: "Origin",
    dir: "请求",
    example: "https://example.com",
    desc: "请求来源（CORS 必读，POST / 跨域自动携带）",
  },
  {
    name: "Referer",
    dir: "请求",
    example: "https://example.com/page",
    desc: "来源页面 URL（拼写错误的历史遗留）",
  },
  {
    name: "User-Agent",
    dir: "请求",
    example: "Mozilla/5.0 ... Chrome/120",
    desc: "用户代理（浏览器、爬虫识别）",
  },
  {
  ...
  },
  {
    ...
    dir: "请求",
    example: "203.0.113.1",
    desc: "客户端真实 IP（Nginx 代理常用）",
  },
  {
    name: "X-Request-Id",
    dir: "请求",
    example: "550e8400-e29b-41d4-a716",
    desc: "请求追踪 ID（分布式链路追踪）",
  },
  {
  ...
  },
  {
    ...
    dir: "响应",
    example: "true",
    desc: "CORS 是否允许携带 Cookie",
  },
  {
    name: "Access-Control-Max-Age",
    dir: "响应",
    example: "86400",
    desc: "预检请求（OPTIONS）结果缓存秒数",
  },
  {
    name: "Age",
    dir: "响应",
  ...
  },
  {
    ...
    dir: "响应",
    example: '"67ab43"',
    desc: "资源版本标识（强 / 弱 ETag）",
  },
  {
    name: "Expires",
    dir: "响应",
    example: "Thu, 01 Dec 2025 16:00:00 GMT",
    desc: "资源过期时间（HTTP/1.0 缓存）",
  },
  {
    name: "Last-Modified",
    dir: "响应",
  ...
  },
  {
    ...
    desc: "认证方式提示（401 响应携带）",
  },
  {
    name: "Allow",
    dir: "响应",
    example: "GET, POST",
    desc: "资源允许的 HTTP 方法（405 响应携带）",
  },
];
