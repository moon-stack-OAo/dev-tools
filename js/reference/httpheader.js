...
function httpheaderRender(filter) {
    ...
    header.style.cssText = 'display:grid;grid-template-columns:240px 60px 240px 1fr;background:var(--bg-input);font-weight:600;border-radius:4px;padding:6px 0;margin-bottom:6px;font-size:12px;position:sticky;top:52px;z-index:5';
    header.innerHTML = `
