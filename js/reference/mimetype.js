const MIME_TYPES = [
  ...
  { ext: ".md", mime: "text/markdown", cat: "文本", desc: "Markdown" },
  {
    ...
    cat: "文本",
    desc: "YAML（也常用 application/yaml）",
  },
  {
    ext: ".properties",
    mime: "text/plain",
  ...
  },
  {
    ...
    mime: "application/java-archive",
    cat: "应用",
    desc: "Java Web Archive",
  },
  {
    ext: ".ear",
    mime: "application/java-archive",
    cat: "应用",
    desc: "Java Enterprise Archive",
  },
  {
    ext: ".class",
