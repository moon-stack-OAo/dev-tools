    ...
    items: [
      ...
      },
      {
        ...
        examples: [
          ...
          'gradle test --tests "*.UserServiceTest.testCreate"',
        ],
        returns: "测试报告",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        syntax:
          "gradle dependencyInsight --dependency <lib> [--configuration <config>]",
        desc: "查看指定依赖来源",
        examples: [
          "gradle dependencyInsight --dependency spring-core",
          "gradle dependencyInsight --dependency lombok --configuration compileClasspath",
        ],
        returns: "依赖来源详情",
      },
      {
