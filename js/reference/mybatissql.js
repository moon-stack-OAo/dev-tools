const MYBATIS_SQL_DATA = [
  ...
  },
  {
    cat: "<foreach>",
    syntax:
      '<foreach collection="list" item="it" open="(" close=")" separator="," index="i">#{it}</foreach>',
  ...
  },
  {
    cat: "<selectKey>",
    syntax:
      '<selectKey keyProperty="id" resultType="long" order="BEFORE|AFTER">SQL</selectKey>',
