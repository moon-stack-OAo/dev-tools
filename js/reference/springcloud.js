    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                example: 'FlowRule rule = new FlowRule("getOrder");\nrule.setControlBehavior(RuleConstant.CONTROL_BEHAVIOR_WARM_UP);'
            }
        ]
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                example: '@TwoPCBusinessAction(name = "deductStock", commitMethod = "commit", rollbackMethod = "rollback")\npublic boolean prepare(BusinessActionContext ctx, Long productId, Integer count) { ... }'
            },
            {
...
function springcloudRender(filter) {
    ...
    SPRING_CLOUD.forEach(group => {
        ...
        const matched = filter
            ? group.items.filter(it => springcloudItemMatches(it, filter))
            : group.items;
