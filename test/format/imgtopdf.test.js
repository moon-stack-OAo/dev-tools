...
const { buildPdf, fitImage, detectFormat, normalizeOptions } = require('../../js/format/imgtopdf.js');
...
function createMockJsPDF() {
    const calls = { addPage: 0, addImage: [], orientation: null, format: null, unit: null };
    return {
        calls,
